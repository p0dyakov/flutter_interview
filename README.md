...
- [Технические вопросы](#-)
  - [Общие](#)
    ...
    - [Что такое ООП? Какие есть принципы ООП? ](#--2)
    - [Что такое компилятор?  ](#--3)
    - [Что такое анонимные функции?   ](#--4)
  ...
  - [Основы Dart ](#-dart)
    ...
    - [Какие типы конструкторов сущестуют в Dart?  ](#-dart-3)
    - [Какие структуры данных есть в Dart?   ](#-dart-4)
  ...
  - [Основы Flutter](#-flutter)
    ...
    - [Инструменты для дебаггинга приложений    ](#--15)
    - [С какими ОС работает Flutter?  ](#-flutter-2)
    - [Какие жесты распознает Flutter?  ](#-flutter-3)
    - [Какие есть режимы сборки во Flutter? ](#-flutter-4)
  ...
  - [Архитектура](#-4)
    ...
    - [Способы осуществления навигации. Плюсы / минусы каждого варианта ](#--27)
    - [Базы данных](#--28)
  - [Bindings](#bindings)
  ...
  - [Flutter под капотом](#flutter-)
    - [Как устроен Flutter](#-flutter-5)
    - [Модель выполнения во Flutter](#-flutter-6)
    - [Построение кадра](#--30)
    - [Какие деревья доступны во Flutter?  ](#-flutter-7)
    - [Расчёт макета](#--31)
