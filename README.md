...
- [Технические вопросы](#-)
  ...
  * [Flutter](#flutter)
    ...
    + [Какие есть режимы сборки во Flutter? ](#-flutter-1)
    ...
    + [Что происходит во время анимации?](#--11)
    + [Какие виды анимаций существуют?](#--12)
    ...
    + [Зачем нужны билдеры?](#--13)
    + [Скроллящиеся списки](#--14)
  ...
  * [Многопоточность](#-2)
    ...
    + [Проблемы многопоточности](#--18)
  * [Архитектура](#-3)
    + [Что такое архитектура?](#--19)
    + [Чистая архитектура](#--20)
    + [Управление состоянием](#--21)
    + [Dependency Injection  ](#dependency-injection)
    + [Фреймворки](#-4)
    + [Архитектурные патерны  ](#--22)
    + [Способы осуществления навигации](#--23)
    + [Базы данных](#--24)
  * [Flutter под капотом](#flutter-)
    + [Что такое WidgetsFlutterBinding?](#-widgetsflutterbinding)
    + [Какие есть Bindings?](#-bindings)
    + [Каналы платформы](#--25)
    + [Как устроен Flutter](#-flutter-2)
    + [Модель выполнения во Flutter](#-flutter-3)
    + [Построение кадра](#--26)
    + [Какие деревья доступны во Flutter?  ](#-flutter-4)
    + [Расчёт макета](#--27)
    + [Что такое BuildOwner?](#-buildowner)
    + [Что такое PipelineOwner?](#-pipelineowner)
    + [Что такое сборщик мусора?](#--28)
    + [Task Runners во Flutter](#task-runners-flutter)
  * [Тестирование](#-5)
    + [Что такое тестирование?](#--29)
    + [Виды тестов](#--30)
    + [Что такое TDD?](#-tdd)
- [Паттерны разработки](#--31)
  * [Подробнее](#-6)
    + [Компоновщик](#-7)
    + [Декоратор](#-8)
    + [Посетитель ](#-9)
