...
- [Технические вопросы](#-)
  - [Общие](#)
    - [Почему для flutter был выбран именно dart?   ](#-flutter-dart)
    - [Какие существуют структуры данных?](#--1)
    - [Что такое ООП? ](#--2)
    - [Что такое компилятор?  ](#--3)
    - [Принципы SOLID  ](#-solid)
    - [Императивное программирование vs декларативное](#-vs-)
    - [Что такое стек?](#--4)
    - [Что такое куча?](#--5)
    - [Что такое DAO?](#-dao)
    - [Что такое DTO?](#-dto)
  ...
  - [Основы Dart ](#-dart)
    - [Что такое dart?  ](#-dart-1)
    - [Различия между final и const  ](#-final-const)
    - [Какие примитивные типы данных есть в Dart?  ](#-dart-2)
    - [Какие структуры данных есть в Dart?   ](#-dart-3)
    - [Что такое Late в dart?  ](#-late-dart)
    - [Что такое Null-safety?  ](#-null-safety)
    - [Можно ли получить null poiner exception?](#-null-poiner-exception)
    - [HashCode](#hashcode)
    - [Какой есть модификатор доступа?  ](#--6)
    - [Что такое extension?](#-extension)
    - [Что такое миксины?](#--7)
    - [Какие есть виды компиляции? ](#--8)
    - [В чём разница между hot restart и hot reload?](#-hot-restart-hot-reload)
    - [Какие есть правила именования?  ](#--9)
    - [Что такое дженерики? ](#--10)
    - [Что такое тип Never?](#-never)
    - [Что такое covariant?](#-covariant)
    - [Что такое deferred?](#-deferred)
    - [Что такое аннотации?](#--11)
    - [Что такое @immutable перед классом?](#-immutable-)
    - [Что такое Dart VM?](#-dart-vm)
  - [Основы Flutter](#-flutter)
    - [Что такое Flutter?](#-flutter-1)
    - [Что такое Widget?  ](#-widget)
    - [Что такое Element?  ](#-element)
    - [Что такое RenderObject?  ](#-renderobject)
    - [Виды элементов](#--12)
    - [Виды виджетов](#--13)
    - [В чем разница между Stateless и Stateful виджетами?](#-stateless-stateful-)
    - [Какой жизненный цикл у Stateful виджета?](#-stateful-)
    - [Какой жизенный цикл у Element-а?](#-element-)
    - [Инструменты для дебаггинга приложений    ](#--14)
    - [Какие есть режимы сборки во Flutter? ](#-flutter-2)
    - [Что такое BuildContext?](#-buildcontext)
    - [В чём разница между Package и Plugin?](#-package-plugin)
    - [В чём отличие между Shared и Transitive зависимостями?](#-shared-transitive-)
    - [Что такое FFI Plugin?](#-ffi-plugin)
    - [Что такое InheritedWidget?  ](#-inheritedwidget)
    - [Какая сложность у операции получения InheritedWidget?](#-inheritedwidget-1)
    - [Что происходит во время анимации?](#--15)
    - [Какие виды анимаций существуют?](#--16)
    - [Что такое Tween?](#-tween)
    - [Tween анимации](#tween-)
    - [Что такое CustomPaint?](#-custompaint)
    - [Что такое GlobalKeys?](#-globalkeys)
    - [Что такое LocalKeys?](#-localkeys)
    - [Зачем нужны билдеры?](#--17)
    - [Скроллящиеся списки](#--18)
    - [Sliver Protocol](#sliver-protocol)
  - [Асинхронность](#-1)
    - [Какие есть операции?](#--19)
  ...
  - [Многопоточность](#-2)
    ...
    - [Проблемы многопоточности](#--22)
  - [Архитектура](#-3)
    - [Что такое архитектура?](#--23)
    - [Чистая архитектура](#--24)
    - [Управление состоянием](#--25)
    - [Dependency Injection  ](#dependency-injection)
    - [Фреймворки](#-4)
    - [Архитектурные патерны  ](#--26)
    - [Способы осуществления навигации](#--27)
    - [Базы данных](#--28)
  - [Flutter под капотом](#flutter-)
    - [Что такое WidgetsFlutterBinding?](#-widgetsflutterbinding)
    - [Какие есть Bindings?](#-bindings)
    - [Каналы платформы](#--29)
    - [Как устроен Flutter](#-flutter-3)
    - [Модель выполнения во Flutter](#-flutter-4)
    - [Построение кадра](#--30)
    - [Какие деревья доступны во Flutter?  ](#-flutter-5)
    - [Расчёт макета](#--31)
    - [Что такое BuildOwner?](#-buildowner)
    - [Что такое PipelineOwner?](#-pipelineowner)
    - [Что такое сборщик мусора?](#--32)
    - [Task Runners во Flutter](#task-runners-flutter)
  - [Разное](#-5)
    - [Что такое тестирование?](#--33)
    - [Виды тестов](#--34)
    - [Что такое TDD?](#-tdd)
    - [Основные git команды](#-git-)
    - [Git Flow](#git-flow)
- [Паттерны разработки](#--35)
  - [Подробнее](#-6)
    - [Компоновщик](#-7)
    - [Декоратор](#-8)
    - [Посетитель ](#-9)
...
- `Dart` соответствует современным "стандартам": ООП, имеет синтаксический сахар, прост для начинающих
...
---
<!-- TOC --><a name="di-vs-service-locator"></a>
...
---
<!-- TOC --><a name="-null-poiner-exception"></a>
...
### Какой жизненный цикл у Stateful виджета?
...
---
<!-- TOC --><a name="-shared-transitive-"></a>
...
---
<!-- TOC --><a name="-inheritedwidget-1"></a>
...
- `ListView` - скроллящийся статический список из виджетов. Все виджеты рисуются сразу и не перерисовываются при скролле. Подходит для небольшого количества элементов
- `ListView.builder` / `ListView.separated` - скроллящийся динамический список из виджетов. Рисуются только виджеты, находящиеся в области видимости вьюпорта. Подходит для большого количества элементов
- `GridView` - скроллящаяся статическия сетка из виджетов. Все виджеты рисуются сразу и не перерисовываются при скролле. Подходит для небольшого количества элементов
- `GridView.builder` -  скроллящаяся динамическая сетка из виджетов. Все виджеты рисуются сразу и не перерисовываются при скролле. Рисуются только виджеты, находящиеся в области видимости вьюпорта. Подходит для большого количества элементов
- `CustomScrollView` - кастомный список, состоящий из сливеров (скроллируемых областей), наследников `RenderSliver` (SliverAppBar, SliverList, SliverGrid, SliverToBoxAdapter и др.). Нужен для сложного поведения. Все вышеперечисленные виджеты под капотом работают со сливерами
...
---
<!-- TOC --><a name="task-runners-flutter"></a>
